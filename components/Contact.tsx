    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-500/10 rounded-full blur-[100px] pointer-events-none animate-float-delayed" />

          <div className="relative glass rounded-3xl p-12 md:p-16 text-center animate-gradient-border gradient-border">
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
              viewport={{ once: true }}
              transition={{ type: "spring", stiffness: 200, delay: 0.2 }}
              className="w-16 h-16 mx-auto mb-8 rounded-2xl bg-brand-500/10 border border-brand-500/20 flex items-center justify-center"
            >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Let&apos;s build
              <br />
              <span className="gradient-text text-glow">something together</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto px-8 py-4 rounded-xl glass glass-hover text-gray-300 font-medium text-lg transition-all flex items-center justify-center gap-2 gradient-border"
              >
