        ...
        >
          ...
          <div className="relative glass rounded-3xl p-12 md:p-16 text-center">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
              ...
              roles. If you&apos;re building something interesting, let&apos;s
              talk.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto px-8 py-4 rounded-xl glass glass-hover text-gray-300 font-medium text-lg transition-all flex items-center justify-center gap-2"
              >
