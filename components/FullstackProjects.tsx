...
const projects = [
  ...
  },
  {
    ...
    description:
      "Online fitness coaching platform with bold dark theme and neon green accents. Features program cards, transformation stats, vertical timeline, and energetic typography.",
    tech: ["Next.js 14", "Tailwind CSS", "Framer Motion", "TypeScript"],
